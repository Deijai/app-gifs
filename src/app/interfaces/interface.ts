// To parse this data:
//
//   import { Convert, GIFType } from "./file";
//
//   const gIFType = Convert.toGIFType(json);
//
...
export class Convert {
  public static toGIFType(json: string): GIFType {
      return cast(JSON.parse(json), r("GIFType"));
  }

  public static gIFTypeToJson(value: GIFType): string {
      return JSON.stringify(uncast(value, r("GIFType")), null, 2);
  }
}
